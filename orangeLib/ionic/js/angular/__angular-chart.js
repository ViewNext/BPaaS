(function (factory) {
  ...
  angular.module('chart.js', [])
    ...
    .directive('chartLine', function (ChartJsFactory) { return new ChartJsFactory('Line'); })
     .directive('chartLineAlt', function (ChartJsFactory) { return new ChartJsFactory('LineAlt'); })
    ...
    .directive('chartDoughnut2', function (ChartJsFactory) { return new ChartJsFactory('Doughnut2'); })
